...
public class CtgStudy {
    ...
    @Getter
    public AnnotationSection annotationSection;
    @Getter
...
class IdentificationModule {
    ...
    public String nctId;
    @Getter
    public List<String> nctIdAliases;
    @Getter
    public OrgStudyIdInfo orgStudyIdInfo;
    @Getter
    public List<SecondaryIdInfo> secondaryIdInfos;
    @Getter
...
class StatusModule {
    ...
    @Getter
    public String delayedPosting;
    @Getter
    public String whyStopped;
    @Getter
    public ExpandedAccessInfo expandedAccessInfo;
    @Getter
    public DateStruct startDateStruct;
    @Getter
    public DateStruct primaryCompletionDateStruct;
    @Getter
    public DateStruct completionDateStruct;
    @Getter
    public String studyFirstSubmitDate;
    @Getter
    public String studyFirstSubmitQcDate;
    @Getter
    public DateStruct studyFirstPostDateStruct;
    @Getter
    public String resultsWaived;
    @Getter
    public String resultsFirstSubmitDate;
    @Getter
    public String resultsFirstSubmitQcDate;
    @Getter
    public DateStruct resultsFirstPostDateStruct;
    @Getter
    public String dispFirstSubmitDate;
    @Getter
    public String dispFirstSubmitQcDate;
    @Getter
    public DateStruct dispFirstPostDateStruct;
    @Getter
    public String lastUpdateSubmitDate;
    @Getter
    public DateStruct lastUpdatePostDateStruct;
}
...
class OversightModule {
    ...
    @Getter
    public String fdaaa801Violation;
}
...
class DesignModule {
    ...
    @Getter
    public String nPtrsToThisExpAccNctId;
    @Getter
    public ExpandedAccessTypes expandedAccessTypes;
    @Getter
...
class ArmsInterventionsModule {
    @Getter
    public List<ArmGroup> armGroups;
    @Getter
...
class ArmGroup {
    ...
    public String description;
    @Getter
    public List<String> interventionNames;
}
...
class Intervention {
    ...
    public String description;
    @Getter
    public List<String> armGroupLabels;
    @Getter
...
class OutcomesModule {
    @Getter
    public List<Outcome> primaryOutcomes;
    @Getter
    public List<Outcome> secondaryOutcomes;
    @Getter
    public List<Outcome> otherOutcomes;
}
...
class ContactsLocationsModule {
    @Getter
    public List<CentralContact> centralContacts;
    @Getter
    public List<OverallOfficial> overallOfficials;
    @Getter
...
class ReferencesModule {
    ...
    @Getter
    public List<SeeAlsoLink> seeAlsoLinks;
    @Getter
    public List<AvailIpd> availIpds;
}
...
class Reference {
    ...
    @Getter
    public List<Retraction> retractions;
}
...
class ResultsSection {
    @Getter
    public ParticipantFlowModule participantFlowModule;
    @Getter
    public BaselineCharacteristicsModule baselineCharacteristicsModule;
    @Getter
    public OutcomeMeasuresModule outcomeMeasuresModule;
    @Getter
    public AdverseEventsModule adverseEventsModule;
    @Getter
    public MoreInfoModule moreInfoModule;
}
...
class ParticipantFlowModule {
    ...
    @Getter
    public String typeUnitsAnalyzed;
    @Getter
...
class Period {
    ...
    @Getter
    public List<DropWithdraw> dropWithdraws;
}
...
class Measure {
    ...
    @Getter
    public String calculatePct;
    @Getter
    public String denomUnitsSelected;
    @Getter
    public List<Denom> denoms;
    @Getter
    public List<MeasureClass> classes;
}
...
class OutcomeMeasuresModule {
    @Getter
    public List<OutcomeMeasure> outcomeMeasures;
}
...
class Analysis {
    ...
    @Getter
    public String statisticalComment;
    @Getter
    public String pValue;
    @Getter
    public String pValueComment;
    @Getter
    public String ciNumSides;
    @Getter
    public String ciPctValue;
    @Getter
    public String ciLowerLimit;
    @Getter
    public String ciUpperLimit;
    @Getter
    public String ciLowerLimitComment;
    @Getter
    public String ciUpperLimitComment;
    @Getter
    public String estimateComment;
    @Getter
    public String testedNonInferiority;
    @Getter
    public String nonInferiorityType;
    @Getter
    public String nonInferiorityComment;
    @Getter
...
class AdverseEventsModule {
    ...
    public String description;
    @Getter
    public String allCauseMortalityComment;
    @Getter
    public List<EventGroup> eventGroups;
    @Getter
    public List<Event> seriousEvents;
    @Getter
...
class EventGroup {
    ...
    public String description;
    @Getter
    public String deathsNumAffected;
    @Getter
    public String deathsNumAtRisk;
    @Getter
    public String seriousNumAffected;
    @Getter
    public String seriousNumAtRisk;
    @Getter
    public String otherNumAffected;
    @Getter
    public String otherNumAtRisk;
}
...
class EventStat {
    ...
    @Getter
    public String numAffected;
    @Getter
    public String numAtRisk;
}

class MoreInfoModule {
    @Getter
    public LimitationsAndCaveats limitationsAndCaveats;
    @Getter
    public CertainAgreement certainAgreement;
    @Getter
...
class CertainAgreement {
    @Getter
    public String piSponsorEmployee;
    @Getter
...
class AnnotationSection {
    @Getter
    public AnnotationModule annotationModule;
}

class AnnotationModule {
    @Getter
    public UnpostedAnnotation unpostedAnnotation;
    @Getter
    public ViolationAnnotation violationAnnotation;
}

class UnpostedAnnotation {
    @Getter
    public String unpostedResponsibleParty;
    @Getter
    public List<UnpostedEvent> unpostedEvents;
}
...
class DocumentSection {
    @Getter
    public LargeDocumentModule largeDocumentModule;
}
...
class LargeDocumentModule {
    ...
    public String noSap;
    @Getter
    public List<LargeDoc> largeDocs;
}
...
class MiscInfoModule {
    ...
    @Getter
    public List<String> removedCountries;
    @Getter
    public SubmissionTracking submissionTracking;
}

class SubmissionTracking {
    @Getter
    public String estimatedResultsFirstSubmitDate;
    @Getter
    public FirstMcpInfo firstMcpInfo;
    @Getter
    public List<SubmissionInfo> submissionInfos;
}

class FirstMcpInfo {
    @Getter
    public DateStruct postDateStruct;
}
...
class SubmissionInfo {
    ...
    public String releaseDate;
    @Getter
    public String unreleaseDate;
    @Getter
    public String unreleaseDateUnknown;
    @Getter
    public String resetDate;
    @Getter
    public String mcpReleaseN;
}
...
class ConditionBrowseModule {
    ...
    @Getter
    public List<Mesh> ancestors;
    @Getter
    public List<BrowseLeaf> browseLeaves;
    @Getter
    public List<BrowseBranch> browseBranches;
}
