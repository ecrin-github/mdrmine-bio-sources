...
public class ConverterCVT
{
    ...
    public static final String FEATURE_PHASE = "Phase";
    public static final String FEATURE_ALLOCATION = "Allocation";
    public static final String FEATURE_INTERVENTION_MODEL = "Intervention model";
    public static final String FEATURE_PRIMARY_PURPOSE = "Primary purpose";
    public static final String FEATURE_MASKING = "Masking";
    public static final String FEATURE_TIME_PERSPECTIVE = "Time perspective";
    public static final String FEATURE_RETROSPECTIVE = "Retrospective";
